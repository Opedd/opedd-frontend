  ...
  return (
    <div className="space-y-4">
      <div className="flex items-baseline justify-between">
        <h2 className="font-bold text-[#040042] text-lg">Onboarding Funnel</h2>
          ...
          return (
            <div key={row.step} className="space-y-1">
              <div className="flex items-baseline justify-between text-sm">
                <span className="font-medium text-[#040042]">
                  {row.step}. {row.name}
                </span>
              ...
              <div className="w-full h-2 bg-[#F3F4F6] rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-[#4A26ED] to-[#7C3AED] rounded-full transition-all"
                  style={{ width: `${pct}%` }}
                />
              </div>
            </div>
