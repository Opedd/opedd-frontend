...
export default function MyLicenses() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F8FA] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center px-4 py-12">
        <div className="w-full max-w-[640px]">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-[#111827]">My Licenses</h1>
            ...
            <div className="mb-8">
              <div className="bg-white border border-[#E5E7EB] rounded-xl p-6 shadow-sm space-y-4">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <Badge className={
                    isRevoked
                      ? "bg-[#FEF2F2] text-[#DC2626] border-[#FECACA] hover:bg-[#FEF2F2]"
                      : "bg-[#ECFDF5] text-[#059669] border-[#A7F3D0] hover:bg-[#ECFDF5]"
                  }>
                    {isRevoked ? (
                  ...
                  <Badge className="bg-[#EEF0FD] text-[#4A26ED] border-transparent hover:bg-[#EEF0FD]">
                    {licenseTypeLabel(license.license_type)}
                  </Badge>
                </div>

                {/* Article title */}
                <h2 className="text-lg font-bold text-[#111827]">{license.article_title}</h2>
                {license.publisher_name && (
                  <p className="text-sm text-[#6B7280]">{license.publisher_name}</p>
                )}
                ...
                <div className="flex items-center gap-2">
                  <code className="text-sm font-mono text-[#4A26ED] bg-[#EEF0FD] px-3 py-1.5 rounded-lg flex-1 truncate">
                    {license.license_key}
                  </code>
                  <button
                    onClick={handleCopyKey}
                    className="shrink-0 p-1.5 text-[#9CA3AF] hover:text-[#111827] transition-colors rounded-lg hover:bg-[#F3F4F6]"
                    title="Copy key"
                  >
                    {copiedKey ? <Check size={16} className="text-[#10B981]" /> : <Copy size={16} />}
                  </button>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    <p className="text-[#9CA3AF] text-xs">Issued</p>
                  ...
                  <div>
                    <p className="text-[#9CA3AF] text-xs">Territory</p>
                    <p className="text-[#111827] font-medium">Worldwide</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 pt-2">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 h-10 px-4 rounded-lg border border-[#E5E7EB] bg-white hover:bg-[#F9FAFB] text-sm font-medium text-[#111827] transition-colors"
                  >
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 text-sm text-[#4A26ED] hover:underline"
                >
              ...
              <button
                ...
                className="text-sm text-[#9CA3AF] hover:text-[#6B7280] transition-colors mt-3 w-full text-center"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white border border-[#E5E7EB] rounded-xl p-6 shadow-sm">
                {emailSent ? (
                  <div className="text-center space-y-3 py-2">
                    ...
                    <h2 className="text-base font-bold text-[#111827]">Check your inbox</h2>
                  ...
                  <>
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-10 h-10 rounded-xl bg-[#EEF0FD] flex items-center justify-center shrink-0">
                        <Mail className="h-5 w-5 text-[#4A26ED]" />
                      </div>
                      <div>
                        <h2 className="text-base font-bold text-[#111827]">Get all my licenses</h2>
                        <p className="text-xs text-[#6B7280]">We'll email them to you</p>
                      </div>
                    </div>
              ...
              <div className="bg-white border border-[#E5E7EB] rounded-xl p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="text-base font-bold text-[#111827]">Look up a license</h2>
                    <p className="text-xs text-[#6B7280]">Enter your license key directly</p>
                  </div>
                </div>
                <form onSubmit={handleKeyLookup} className="space-y-3">
                  <Input
                    ...
                    required
                  />
                  {keyError && <p className="text-sm text-[#EF4444]">{keyError}</p>}
      ...
      {/* Footer */}
      <div className="px-6 py-4 text-center border-t border-[#E5E7EB]">
        <div className="flex items-center justify-center gap-4">
          <Link to="/verify" className="text-xs text-[#9CA3AF] hover:text-[#6B7280]">Verify a license</Link>
          <span className="text-[#E5E7EB]">·</span>
          <Link to="/licenses" className="text-xs text-[#9CA3AF] hover:text-[#6B7280]">Advanced portal</Link>
          <span className="text-[#E5E7EB]">·</span>
          <a href="mailto:support@opedd.com" className="text-xs text-[#9CA3AF] hover:text-[#6B7280]">Support</a>
        </div>
      </div>
    </div>
  );
