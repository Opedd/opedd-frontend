...
export default function ArchiveLicenseCheckout() {
  ...
  if (notFound || !publisher) {
    return (
      <div className="min-h-screen bg-[#F7F8FA] flex flex-col items-center justify-center gap-4 px-4">
        ...
        <p className="text-[#6B7280] text-sm">Publisher not found.</p>
      </div>
    );
  }
  ...
  if (noArchivePrice) {
    return (
      <div className="min-h-screen bg-[#F7F8FA] flex flex-col items-center justify-center gap-4 px-4">
        <img src={opeddLogoColor} alt="Opedd" className="h-7 opacity-60" />
        <p className="text-[#111827] text-sm font-medium">Archive licensing not available</p>
    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 bg-white min-h-screen">
        <div className="max-w-lg mx-auto px-5 md:px-10 py-10 md:py-14">
          <h2 className="text-lg font-semibold text-[#111827] mb-1">Purchase Archive License</h2>
          <p className="text-sm text-[#6B7280] mb-8">Complete the form below to secure full catalog access.</p>
