...
import { Shield, Trash2, Image, Settings, DollarSign, RefreshCw, Loader2, HelpCircle, FileText, Rss, CheckCircle, Clock, Wallet, ShieldCheck } from "lucide-react";
        ...
        <AlertDialogContent className="bg-white border-gray-200 rounded-2xl">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-[#040042]/60">
              This action cannot be undone. The selected assets will be permanently removed from your library.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
