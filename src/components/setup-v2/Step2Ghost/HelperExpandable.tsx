...
// Phase 7.5 — Reusable "Where do I find this?" expandable hint.
//
// Mirrors Step2Beehiiv/HelperExpandable.tsx (Phase 6.5 ship at commit
// dbcf12e). Component is platform-agnostic — Step2Ghost owns its own
// namespace copy per Phase 6.5 component-ownership pattern. Future
// cleanup-audit may promote to a shared location if a third platform
// onboarding ships in Phase 8/9.
//
// Independent open/closed state per instance — Step2Ghost has two
// (one per field) and per design doc § 3 helper-text framing they
// expand independently (no auto-collapse coupling).
//
